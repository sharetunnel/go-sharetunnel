...
// testsharetunnel against server at baseURL (if given)
func testsharetunnel(baseURL string, t *testing.T) {
	...
	if err != nil {
		t.Fatal("failed to create sharetunnel, error: ", err)
	}
...
func Testsharetunnel(t *testing.T) {
	testsharetunnel("", t)
}
